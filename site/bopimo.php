...
if(!isset($bop)) {
	class bopimo {
		...
		public function __construct () {
			try {
				$this->pdo = new PDO( 'mysql:host=45.55.203.85;dbname=bricabrac', 'root', 'n=q5w84W%N@M+ZV<' ); //declare PDO
			} catch (Exception $e) {
				die();
			}
		}
		...
		*/
		...
		{
			$pdo = new PDO( 'mysql:host=45.55.203.85;dbname=bricabrac', 'root', 'n=q5w84W%N@M+ZV<' ); //declare PDO
		...
		{
			$pdo = new PDO( 'mysql:host=45.55.203.85;dbname=bricabrac', 'root', 'n=q5w84W%N@M+ZV<' );
